...
public class KankoreziaiDbContext : DbContext
{
    ...
    public DbSet<KankoreziaiUser> Users { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<KankoreziaiUser>()
    ...
    public void InitializeData()
    {
        ...
        Users.AddRange(new List<KankoreziaiUser>() { new() { Email = "testemail@gmail.com", Permissions = new(new[] { "items.see", "items.manage" }) } });
        SaveChanges();
    }
}
